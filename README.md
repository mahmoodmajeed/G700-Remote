...
This repository started from the v1.2 baseline and now tracks the v1.6.5 release. It is intended as the clean source baseline for future development, CI, Play Store preparation, and Codex-assisted changes.
...
- v1.6.5 is a silent bug-fix build on top of v1.6.3 with the same user-facing release notes.
