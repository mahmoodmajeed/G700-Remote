...
This document records the compatibility assumptions used for the v1.4.4 release. It is a source summary, not a replacement for re-checking future DisplayMirror APK releases.
